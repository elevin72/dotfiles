...
JAR="$HOME/.local/share/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/plugins/org.eclipse.equinox.launcher_*.jar"
GRADLE_HOME=$HOME/gradle /usr/lib/jvm/java-16-openjdk/bin/java \
  ...
  -Xmx2G \
  -jar $(echo "$JAR") \
  -configuration "$HOME/.local/share/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_linux" \
